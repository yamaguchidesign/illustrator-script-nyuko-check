...
// 共通のチェックマーク作成関数を追加
function createCheckMark(parent) {
    var checkMark = parent.add("statictext", undefined, "✓");
    checkMark.characters = 2;
    checkMark.margins = [0, 0, 2, 0];
    checkMark.graphics.font = ScriptUI.newFont("Arial", "REGULAR", 13);
    var greenPen = checkMark.graphics.newPen(checkMark.graphics.PenType.SOLID_COLOR, [0, 0.8, 0, 1], 1);
    checkMark.graphics.foregroundColor = greenPen;
    return checkMark;
}
...
var checkModules = {
    ...
    artboardDecimal: {
        ...
        createUI: function(parent) {
            ...
            // チェックマーク用のテキスト
            this.checkMark = createCheckMark(headerGroup);
        ...
        updateUI: function(results) {
            if (results.artboardDecimals.length > 0) {
                this.checkMark.visible = false;
                this.resultText.text = results.artboardDecimals.length + "個";
                this.resultText.graphics.foregroundColor = this.redPen;
                this.detailText.text = "アートボード番号：" + results.artboardDecimals.join(", ");
            } else {
                this.checkMark.visible = true;
                this.resultText.text = "0個";
                this.resultText.graphics.foregroundColor = this.blackPen;
    ...
    lockHideCheck: {
        ...
        createUI: function(parent) {
            ...
            this.checkMark = createCheckMark(lockGroup);
            ...
            this.hideCheckMark = createCheckMark(hideGroup);
        ...
        check: function() {
            ...
            if (counts.hidden > 0) {
                this.hideCheckMark.visible = false;
                this.hideText.graphics.foregroundColor = this.redPen;
            } else {
                this.hideCheckMark.visible = true;
    ...
    fontCheck: {
        ...
        createUI: function(parent) {
            ...
            this.checkMark = createCheckMark(countGroup);
    ...
    unnecessaryObjectCheck: {
        ...
        createUI: function(parent) {
            ...
            this.strayCheckMark = createCheckMark(strayGroup);
            ...
            this.noFillCheckMark = createCheckMark(noFillGroup);
            ...
            this.emptyTextCheckMark = createCheckMark(emptyTextGroup);
        ...
        check: function() {
            ...
            this.strayCheckMark.visible = counts.strayPoints === 0;
            ...
            this.noFillCheckMark.visible = counts.noFill === 0;
            if (counts.noFill > 0) {
            ...
            this.emptyTextCheckMark.visible = counts.emptyText === 0;
        ...
        updateUI: function(results) {
            ...
            this.strayCheckMark.visible = results.strayPoints === 0;
            this.noFillCheckMark.visible = results.noFillCount === 0;
            this.emptyTextCheckMark.visible = results.emptyTextCount === 0;
            ...
            this.deleteButton.enabled = (results.strayPoints > 0 || results.noFillCount > 0 || results.emptyTextCount > 0);
        }
    }
};
...
// 各モジュールのupdateUI関数を実装
checkModules.artboardDecimal.updateUI = function(results) {
    this.resultText.text = results.artboardDecimals.length + "個";
    this.checkMark.visible = results.artboardDecimals.length === 0;
    if (results.artboardDecimals.length > 0) {
        this.resultText.graphics.foregroundColor = this.redPen;
    } else {
        this.resultText.graphics.foregroundColor = this.blackPen;
